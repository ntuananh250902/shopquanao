...
<body>
	...
	<p>
		<a class="btn btn-info" href="createDanhMucAction">Thêm mới</a>
	</p>
	...
	<table class="table">
		...
		<s:iterator var="dm" value="danhMucList" status="status">
			<tr>
				<td><s:property value="#status.index + 1" /></td>
				<td><s:property value="ten" /></td>
				<td><s:property value="trangthai" /></td>
				<td><a class="btn btn-warning"
					href='editDanhMucAction?id=<s:property value="id"/>'>Chỉnh sửa</a></td>
				<td><a class="btn btn-danger"
					href='deleteDanhMucAction?id=<s:property value="id"/>'
