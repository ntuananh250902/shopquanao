...
<body>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
					...
					<li class="nav-item"><a class="nav-link"
						href="listDanhMucAction">QUẢN LÝ DANH MỤC</a></li>
	...
	<s:form action="storeFoodAction" method="POST"
		...
		<s:select label="Danh mục" name="danhmuc" headerKey=""
			headerValue="-- Chọn danh mục--" list="danhMucList" listKey="id"
			listValue="ten" />
		<s:file name="hinh" id="hinh" label="Chọn hình cho sản phẩm"
