...
<body>
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
					...
					<a class="nav-link dropdown-toggle" id="navbarDropdown" href="#"
						...
						<s:iterator var="danhmuc" value="danhMucList">
							<li><a style="cursor: pointer;" href="#" class="dropdown-item"><s:property value="ten"/></a></li>
								</s:iterator>
						</ul></li>
				<s:form action="searchAction" method="post" validate="true">
						<table>
							<tr>
								<td><input class="form-control" type="text" name="keyword" id="keyword"
	...
	<section class="py-5">
		<div class="container px-4 px-lg-5 mt-1">
			<h3 class="text-dark">Từ khóa tìm kiếm "<s:property value="%{word}" />"</h3>
							...
							<div class="card-body p-4">
								<div class="text-center">
									...
									<h5 class="fw-bolder text-info">
										<a class="text-decoration-none" href="chitietAction?idmonan=<s:property value="id"/>"> <s:property value="ten" />
										</a>
									</h5>
									<!-- Product reviews-->
									<div
							...
							<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
								<div class="text-center">
									<a class="btn btn-outline-info mt-auto"
										href='chitietAction?idmonan=<s:property value="id"/>'>Chọn
										mua</a>
								</div>
							</div>
						</div>
