...
-- Thêm dữ liệu table
-- Table datmon
INSERT INTO `giohang` ( `idnguoidung`, `idsanpham`, `soluong`, `gia`, `thanhtien`,`thanhtoan`) VALUES
(1, 1, 2, 25000, 50000,0);
INSERT INTO `giohang` ( `idnguoidung`, `idsanpham`, `soluong`, `gia`, `thanhtien`,`thanhtoan`) VALUES
(1, 5, 2, 25000, 50000,0);
-- Table monan
INSERT INTO `sanpham` (`iddanhmuc`, `tensanpham`, `hinhanh`, `gia`,`trangthai`) VALUES
-- Áo khoác
...
ALTER TABLE `giohang`
  ADD CONSTRAINT `fk_giohang_nguoidung` FOREIGN KEY (`idnguoidung`) REFERENCES `nguoidung` (`id`),
  ADD CONSTRAINT `fk_datmon_monan` FOREIGN KEY (`idsanpham`) REFERENCES `sanpham` (`id`);
COMMIT;
ALTER TABLE `sanpham`
  ADD CONSTRAINT `fk_sanpham_danhmuc` FOREIGN KEY (`iddanhmuc`) REFERENCES `danhmuc` (`id`);
Commit;
